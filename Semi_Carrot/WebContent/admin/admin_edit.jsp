...
<article class="join-article">
	<form action="change_info_admin.do" method="get" class="join-form"
		id="edit-form" onsubmit="return editSubmit();">
		...
		<div class="email-form">
			<input type="text" name="member_id" placeholder="이메일" id="email"
				value="<%=mdto.getMember_id()%>" readonly style="width: 500px;">
		</div>
		
		<div id="pwInfo"></div>
		<div>
			<input type="password" name="check_pw" placeholder="비밀번호 수정"
				maxlength="15" oninput="editcheckPw();" style="color: #ff8900;">
		</div>
		<div id="editpwInfo"></div>
		<div>
			<input type="password" name="check_member_pw" placeholder="비밀번호 확인"
				maxlength="15" oninput="doublecheckPw();" style="color: #ff8900;">
		</div>
		<div id="checkpwInfo"></div>
		<div>
			<input type="text" name="member_nick" placeholder="닉네임"
				maxlength="10" value="<%=mdto.getMember_nick()%>"
				oninput="checkNick();" style="color: #ff8900;">
		</div>
		<div id="nickInfo"></div>
		<div id="addr">
			<input type="text" name="addr_state" placeholder="시 / 도" id="state"
				value="<%=state%>" style="color: #ff8900;" readonly> <input
				type="text" name="addr_city" placeholder="구 / 시" id="city"
				value="<%=city%>" style="color: #ff8900;" readonly> <input
				type="text" name="addr_base" placeholder="동 / 읍 / 면" id="base"
				value="<%=base%>" style="color: #ff8900;" readonly> <input
				type="button" onclick="findAddr(); " value="">
		</div>
		<div>
			<input type="text" name="member_phone" placeholder="휴대전화"
				maxlength="11" value="<%=mdto.getMember_phone()%>"
				oninput="checkPhone();" style="color: #ff8900;">
		</div>
