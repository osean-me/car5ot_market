			...
			<div class=detail>
				...
				<div class="product">
					<div class="product_photo">
						<a class="move"
							href="promotion_post_content.jsp?board_no=<%=dldto.getBoard_no()%>&promotion_cate_num=<%=dldto.getPromotion_cate_num()%>&post_no=<%=dldto.getPost_no()%>"><img
							src="showImg2.do?post_img_no=<%=dldto.getPost_img_no()%>"></a>
					</div>
					<div class="product_title">
						<div class="hideText">
							<a class="move"
								href="promotion_post_content.jsp?board_no=<%=dldto.getBoard_no()%>&promotion_cate_num=<%=dldto.getPromotion_cate_num()%>&post_no=<%=dldto.getPost_no()%>"><%=dldto.getPost_title()%></a>
						</div>
					</div>
