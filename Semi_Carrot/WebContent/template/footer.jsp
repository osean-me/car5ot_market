    ...
    pageEncoding="UTF-8"%>
		...
		<footer>
			...
			<div class="footer-middle-top">
				<a href="">사업자 등록번호 : 000-00-00000</a> <a href="">서울특별시 구로구 디지털로
					30길 28 마리오타워 609호</a>
			</div>
			<div class="footer-middle-center">
				<a href="">고객 문의 : danggeun@market.co</a> <a href="">제휴 문의 :
					contact@market.co</a>
			</div>
			<div class="footer-middle-bottom">
				<a href="">(주)당근마켓 대표 김누구, 박저기</a>
			</div>
			<div class="footer-bottom">Copyright © Danggeun Market Inc. All
				rights reserved.</div>
			<div class="footer-icon">
				<a><img src="./img/facebook.png"></a> <a><img
