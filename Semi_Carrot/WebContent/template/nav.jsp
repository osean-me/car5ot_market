				...
				<ul>
					<li class="medium-menu"><a href="<%=path%>/board/post_list.jsp" class="category">동네 중고</a>
						<ul>
							...
							<li><a href="<%=path%>/board/post_list.jsp?board_no=1&used_cate_num=6">여성 잡화</a></li>
							<li><a href="<%=path%>/board/post_list.jsp?board_no=1&used_cate_num=7">여성 의류</a></li>
					...
					<li class="medium-menu"><a href="<%=path%>/board/post_list.jsp" class="category">동네 홍보</a>
						<ul>
					...
					<li class="medium-menu"><a href="<%=path%>/board/used_write.jsp"" class="category"> 판매하기</a>
				</ul>
			</div>
		</nav>
