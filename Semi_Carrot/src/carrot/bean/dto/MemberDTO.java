...
private String member_buy;
private String member_sell;
...
public String getMember_buy() {
	return member_buy;
}

public void setMember_buy(String member_buy) {
	this.member_buy = member_buy;
}

public String getMember_sell() {
	return member_sell;
}

public void setMember_sell(String member_sell) {
	this.member_sell = member_sell;
}
...
private String member_like;
	...
	public MemberDTO(ResultSet rs) throws Exception {
		...
		this.setMember_buy(rs.getString("MEMBER_buy"));
		this.setMember_sell(rs.getString("MEMBER_sell"));
		this.setMember_like(rs.getString("MEMBER_like"));
